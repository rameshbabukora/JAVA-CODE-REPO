...
public class SpringBoot2RestCrudMySqlExApplicationTests {
	...
	public void testCreateProduct() throws Exception {
		...
		MockHttpServletRequestBuilder request = 
				...
				.post("/rest/product/save")
				.contentType(MediaType.APPLICATION_JSON)
				.content("{\"prodCode\":\"PEN\",\"prodCost\":320.0}");
	...
	public void testUpdateProduct() throws Exception {
		...
		MockHttpServletRequestBuilder request =
				MockMvcRequestBuilders
				.put("/rest/product/modify")
				.contentType(MediaType.APPLICATION_JSON)
				.content("{\"prodId\":1,\"prodCode\":\"NEW PEN\",\"prodCost\":420.0}");
	...
	public void testDeleteProductNotExist() throws Exception {
		//  I. create one Request using Mocking
		MockHttpServletRequestBuilder request = 
				MockMvcRequestBuilders.delete("/rest/product/remove/{id}",500);
